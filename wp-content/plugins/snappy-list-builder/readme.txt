=== Snappy List Builder ===
Contributors: madesnappy
Donate link: http://wordpressplugincourse.com/plugins/snappy-list-builder
Tags: Email, Subscribe, Email List, Email Subscribers, List Builder, Newsletter, MailChimp, CSV, Opt-in, Double Opt-in, Double Optin, Optin, Plugin Course, Ultimate 
...
6. Plugin Options page

7. Plugin Dashboard

8. Email Capture Form Example

9. Manage Subscriptions / Unsubscribe

10. New Subscription Confirmation
...
= 1.0.1.2 - 
This upgrade fixes some display issues in WordPress 4.3
